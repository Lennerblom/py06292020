...
request = requests.get("https://api.spacexdata.com/v3/capsules")

count = 0
for mission in spacex:
    if mission["missions"][0].__len__() > 0:
        count +=1
        print(count, mission["missions"][0]["name"])
